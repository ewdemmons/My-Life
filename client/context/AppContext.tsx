...
const defaultTasks: Task[] = [
  ...
  { id: "t4a", title: "Dark mode improvements", description: "Better contrast ratios. See Apple guidelines: https://developer.apple.com/design/human-interface-guidelines/color", type: "idea", categoryId: "3", parentId: "t4", dueDate: null, priority: "low", status: "pending", createdAt: Date.now() + 1 },
